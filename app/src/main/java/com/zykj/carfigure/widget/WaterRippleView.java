...
public class WaterRippleView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int waveColor = typedArray.getColor(R.styleable.WaterRippleView_customColor,
                ContextCompat.getColor(context, R.color.colorPrimary));
        Drawable drawable = typedArray.getDrawable(R.styleable.WaterRippleView_customCenterIcon);
        mRippleCount = typedArray.getInt(R.styleable.WaterRippleView_customCount, 2);
        mRippleSpacing = typedArray.getDimensionPixelSize(R.styleable.WaterRippleView_customSpacing,
                16);
        mRunning = typedArray.getBoolean(R.styleable.WaterRippleView_customAutoRunning, false);
        typedArray.recycle();
