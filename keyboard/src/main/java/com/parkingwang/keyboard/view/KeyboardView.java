...
public class KeyboardView extends LinearLayout {
     ...
     */
    public void update( final String number, final int showIndex, final boolean showMore, final NumberType fixedNumberType) {
     ...
     * @param callback 回调接口
     */
    public void addKeyboardChangedListener( OnKeyboardChangedListener callback) {
     ...
     * @param callback 回调接口
     */
    public void removeKeyboardChangedListener( OnKeyboardChangedListener callback) {
